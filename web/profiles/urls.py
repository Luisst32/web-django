...
from .views import perfil_detalle,seguir_usuario,dejar_de_seguir,editar_perfil,top_seguidores, top_fracasados
...
urlpatterns = [
    ...
    path('top-fracasados/', top_fracasados, name='top_fracasados'),
